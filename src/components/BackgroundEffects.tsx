...
const BackgroundEffects = () => (
  <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
    ...
    {/* Vignette overlay for edge focus */}
    ...
    {/* LAYER 4: Blurred mini UI elements */}
    {/* Mini graph card - top right */}
    ...
    {/* Dashboard snippet - bottom right */}
    ...
    <div className="absolute bottom-[10%] left-[30%] w-[350px] h-[350px] rounded-full bg-cyan/[0.04] blur-[100px] animate-float-slow" style={{ animationDelay: "2s" }} />
